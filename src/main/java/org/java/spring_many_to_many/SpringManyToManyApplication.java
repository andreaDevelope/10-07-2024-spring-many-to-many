...
public class SpringManyToManyApplication implements CommandLineRunner {
	...
	public void testNoRelations(){
		Employee e1 = new Employee("Rollo Pollo","rolloNumerOne", 150000);
		Employee e2 = new Employee("Carlo Magno","meMagnoTutto", 200000);
	...
	public void testRelationsManyToMany(){
		...
		Employee e3 = new Employee("Maldi Testa", "cioMalDiTesta", 300000);
